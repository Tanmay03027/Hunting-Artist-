<?php
	...
	if(ISSET($_POST['login'])){
		...
		$password = $_POST['password'];
                    $check=mysqli_query($conn,"select * from recruiter_account where Email='$email'and Password ='$password'");
   ...
   <div class="box6">
    <div class="container7">
        ...
        <div class="two-col">
            ...
            <div class="two">
                <label><a href="forgot_password_recruiter.php">Forgot password?</a></label>
            </div>
        </div>
    </div>
</div>  
