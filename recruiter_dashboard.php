...
$query = "SELECT * FROM `recruiter_account` WHERE Email='$email';";
...
if(isset($_POST['submit']))
{
    ...
    if(in_array($file_extension, $extension) && $img_size < 500000) // Maximum allowed size is 500KB
    {
        ...
        $sql="UPDATE `recruiter_account` SET `Image`='$upload_img' WHERE Email='$email'";
...
<html lang="en">
    <head>
        ...
        <title>Recruiter User Account</title>
...
<br><br><br><br><br><br><br><br><br><br>
        ...
        <div id="London" class="tabcontent">
            <div class="cross">
                ...
                <p><b class="txt">Place:&nbsp;</b><?php echo $row['Place']; ?></p><br><br>

                <p><b class="txt">Company Name:&nbsp;</b><?php echo $row['Company_Name']; ?></p><br><br>
